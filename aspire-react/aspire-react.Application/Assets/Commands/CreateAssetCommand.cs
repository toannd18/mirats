...
public class CreateAssetCommandHandler : IRequestHandler<CreateAssetCommand, AssetResult>
{
    ...
    public CreateAssetCommandHandler(IApplicationDbContext context, IActionLogService actionLogService, ICompanyScopeService companyScope, IAssetTagGenerator assetTagGenerator)
    {
        _context = context;
