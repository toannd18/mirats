...
export type ImportType = 'reference' | 'asset-models' | 'assets' | 'components' | 'accessories' | 'consumables' | 'systems' | 'system-positions';
 ...
 *  The 5 inventory/reference types (incl. asset-models) share the "assets" template workbook;
 *  systems/positions use the "systems" template workbook. */
