...
public class AuditAssetCommandHandler : IRequestHandler<AuditAssetCommand, AuditResult>
{
    ...
    public AuditAssetCommandHandler(AppDbContext context, IActionLogService actionLogService)
    {
        _context = context;
...
public class BulkAuditAssetsCommandHandler : IRequestHandler<BulkAuditAssetsCommand, BulkAuditResult>
{
    ...
    public BulkAuditAssetsCommandHandler(AppDbContext context, IActionLogService actionLogService)
    {
        _context = context;
        _actionLogService = actionLogService;
    }
