...
public class AcceptAssetCommandHandler : IRequestHandler<AcceptAssetCommand, AcceptDeclineResult>
{
    ...
    public AcceptAssetCommandHandler(AppDbContext context, IActionLogService actionLogService)
    {
        _context = context;
...
public class DeclineAssetCommandHandler : IRequestHandler<DeclineAssetCommand, AcceptDeclineResult>
{
    ...
    public DeclineAssetCommandHandler(AppDbContext context, IActionLogService actionLogService)
    {
        _context = context;
        _actionLogService = actionLogService;
    }
